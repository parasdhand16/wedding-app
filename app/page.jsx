...
export default function WeddingTracker() {
  ...
  const allGuests = members.flatMap((m) =>
    m.guests.map((g) => ({ ...g, memberId: m.id }))
  );
    ...
    >
      ...
      {count > 0 && (
        <span
          style={{
            marginLeft: 5,
            background: tabActive(id) ? "rgba(255,255,255,0.2)" : "#efe9e0",
            borderRadius: 8,
            padding: "1px 6px",
            fontSize: 10,
          }}
      ...
      <div style={{ textAlign: "center", marginBottom: 18 }}>
        ...
        <div
          style={{
            width: 60,
            height: 2,
            background: "linear-gradient(90deg,transparent,#c4a97d,transparent)",
            margin: "6px auto 0",
          }}
        />
      </div>
          ...
          <>
            ...
            >
              {totalByEvent.map((ev) => (
                ...
                >
                  <Donut
                    value={ev.adults + ev.children}
                    total={maxEvPeople}
                    size={94}
                    strokeW={10}
                    colors={{
                      fill: EVENT_COLORS[ev.event],
                      track: "#f0ebe4",
                      text: "#3d3428",
                    }}
                    centerLabel="people"
                  ...
                  <div style={{ display: "flex", gap: 8, fontSize: 10, color: "#a09585" }}>
                    <span>{ev.adults} adults</span>
                    <span>{ev.children} kids</span>
                  </div>
                </div>
              ))}
            </div>
              ...
              <>
                ...
                >
                  ...
                  >
                      ...
                      {editingMemberName === activeMember.id ? (
                        <input
                          ...
                          onChange={async (e) => {
                            ...
                            updateMember(activeMember.id, (m) => ({
                              ...m,
                              name: newName,
                            }));
                    ...
                    <button
                      onClick={() => addGuest(activeMember.id)}
                      style={{
                        background: "#6b8f71",
                        color: "#fff",
                        border: "none",
                    ...
                    {ms.byEv.map((ev) => (
                      <div
                        ...
                        style={{
                          ...
                          borderRadius: 10,
                          background: "#faf7f2",
                          borderLeft: `3px solid ${EVENT_COLORS[ev.event]}`,
                        }}
                      >
                        <div
                          style={{
                      ...
                      <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
                        ...
                        <tbody>
                          {activeMember.guests.map((g, idx) => {
                            ...
                            const dup = g.name.trim()
                              ? findDuplicate(g.name, g.id, activeMember.id)
                              : null;
                            const showDupWarning = dup && !g.dupAcknowledged;

                            const cs = {
                              padding: "7px 8px",
                              borderBottom: showDupWarning ? "none" : "1px solid #f5f0e8",
                              color: "#4a3f33",
                              whiteSpace: "nowrap",
                            };
                                ...
                                >
                                  ...
                                  <td style={cs}>
                                    <div style={{ display: "flex", gap: 3 }}>
                                      ...
                                      <button
                                        onClick={() => removeGuest(activeMember.id, g.id)}
                                        style={{
                                          background: "none",
                                          border: "none",
                                          padding: "3px 5px",
